...
DURATION_TYPE = "1min"
OUTPUT_COST_DIR = 'data/query_cost_queries_case3_aws'
...
class QueryTraining(object):
    ...
    def __init__(self, refined_queries = None, fname_rq_read = '', fname_rq_write = '',
        ...
        REFINED_QUERY_PATH = 'data/refined_queries_queries_case3_1min_aws.pickle'
        ...
        fname_rq_read = 'data/refined_queries_queries_case3_1min_aws.pickle'
