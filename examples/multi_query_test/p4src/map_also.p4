...
action do_distinct_0_1_hashes() {
	modify_field(hash_meta_distinct_0_1.sIP, meta_map_3_1.sIP);
	modify_field(hash_meta_distinct_0_1.dIP, meta_map_3_1.dIP);
...
action do_map_3_1()  {
   ...
   bit_and(meta_map_3_1.dIP, meta_map_3_1.dIP, 0xffff0000);
}
