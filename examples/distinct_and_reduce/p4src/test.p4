...
action do_encap_1() {
	...
	modify_field(out_header_1.dIP, hash_meta_distinct_1_1.dIP);
	modify_field(out_header_1.sIP, hash_meta_distinct_1_1.sIP);
}
...
action do_distinct_1_1_hashes() {
	modify_field(hash_meta_distinct_1_1.sIP, ipv4.srcAddr);
	modify_field(hash_meta_distinct_1_1.dIP, ipv4.dstAddr);
