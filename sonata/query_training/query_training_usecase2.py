...
DURATION_TYPE = "1min"
OUTPUT_COST_DIR = 'data/query_cost_queries_case2_aws'
...
class QueryTraining(object):
    ...
    def __init__(self, refined_queries = None, fname_rq_read = '', fname_rq_write = '',
        ...
        if query_generator is None:
            if fname_qg == '':
                fname_qg = 'query_engine/use_cases_aws/query_generator_object_case2.pickle'
        ...
        REFINED_QUERY_PATH = 'data/refined_queries_queries_case2_1min_aws.pickle'
        ...
        fname_rq_read = 'data/refined_queries_queries_case2_1min_aws.pickle'
