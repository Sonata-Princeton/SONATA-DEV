...
def main():
    ...
    dpd = DataplaneDriver(DP_DRIVER_CONF, BASEPATH + SONATA +"/sonata/tests/lines_of_code/q6/results/dp_driver.log")
    p4_type = P4_TYPE
    compiled_srcs = ''
    ...
    config = {
        'em_conf': {'spark_stream_address': SPARK_ADDRESS,
                    ...
                    'log_file': BASEPATH + SONATA +"/sonata/tests/lines_of_code/q6/results/emitter.log"
        },

        'switch_conf': {
            'compiled_srcs': BASEPATH + SONATA +'/sonata/tests/lines_of_code/q6/compiled_srcs/',
