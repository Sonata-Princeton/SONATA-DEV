...
def generate_graph(sc, query, min):
    TD_PATH = '/mnt/anon_all_flows_20sec.csv'
    ...
    G = hypothesis.G
    fname = 'data/hypothesis_graph_'+str(query.qid) + '_learning_' +'_1min_' + str(min) + '_'+str(datetime.datetime.fromtimestamp(time.time()))+'.pickle'
...
if __name__ == '__main__':
    ...
    print "Starting: ", str(q.qid)
    generate_graph(sc, q, 0)
    sc.stop()
